...
- `InventoryIntelligence`: leitura de repositorios/dossies e sinais.
- `ReportingView`: visoes de UI (`Projetos`, `Kanban`, `Grafo`, `Inventario`).

## Relacoes
- `InventoryIntelligence -> PortfolioResearch`: sinais alimentam projetos `INV-*`.
